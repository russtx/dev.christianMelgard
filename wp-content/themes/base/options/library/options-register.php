...
foreach ( $gpp_tabs as $tab ) {
	...
	foreach ( $tabsections as $section ) {
		...
		add_settings_section( 'gpp_' . $section['name'] . '_section', '<span class="tab_section ' . $tabname . '" id=' . $section['name'] . '>' . $section['title'] . '</span>', 'gpp_sections_callback', 'gpp_' . $tabname . '_tab' );
