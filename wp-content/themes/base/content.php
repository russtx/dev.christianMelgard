<?php
/**
 * The template for displaying posts in the Default Post Format on index and archive pages
 *
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if ( !is_search() && !is_archive() ) { gpp_base_meta(); } //call meta data if not search or archive  ?>
